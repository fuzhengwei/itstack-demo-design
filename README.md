...
- [1. 重学 Java 设计模式：实战工厂方法模式(多种类型商品发奖场景)](https://bugstack.cn/itstack-demo-design/2020/05/20/重学Java设计模式-实战工厂方法模式.html)
- [2. 重学 Java 设计模式：实战抽象工厂模式(替换Redis双集群升级场景)](https://bugstack.cn/itstack-demo-design/2020/05/24/重学Java设计模式-抽象工厂模式.html)
- [3. 重学 Java 设计模式：实战建造者模式(装修物料组合套餐选配场景)](https://bugstack.cn/itstack-demo-design/2020/05/26/重学Java设计模式-实战建造者模式.html)
- [4. 重学 Java 设计模式：实战原型模式(多套试每人题目和答案乱序场景)](https://bugstack.cn/itstack-demo-design/2020/05/28/重学-Java-设计模式-实战原型模式.html)
- [5. 重学 Java 设计模式：实战单例模式(Effective Java 作者推荐枚举单例模式)](https://bugstack.cn/itstack-demo-design/2020/05/31/重学-Java-设计模式-实战单例模式.html)
